            ...
            <div key={product.id} className="productCard m-1 box">
              ...
              <div className=" flex justify-between flex-col ">
                ...
                <div className={"grid mb-2 " + (page == 'allProducts' ? 'grid-cols-2 ' : 'grid-cols-1 ')}>
                  <button onClick={addToCart} className={"productCard-checkoutBtn p-1 text-sm font-medium text-gray-900 box rounded-lg" + (page == 'allProducts' ? ' ' : ' hidden')}>Add to Cart</button>

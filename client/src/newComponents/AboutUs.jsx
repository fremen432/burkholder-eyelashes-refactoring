...
const myComp2 = () =>
    <div id="AboutUs" className="section SECTION__AboutUs bg-white box ">
    ...
    <div className="AboutUs_Employees_Container" >
        {people.map((person) => (
            <div key={person.name} className="">
                <img className="" src={person.imageUrl} alt="" />
                <div className="">
                    <div className="">
                        <h3>{person.name}</h3>
                    ...
                    {/* Social Media */}
                    <div className="">
                        <a href={person.twitterUrl} className="">
                            <span className="">Twitter</span>
                            <svg className="" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
...
const componentMine = () =>
    <div id="AboutUs" className="section SECTION__AboutUs">

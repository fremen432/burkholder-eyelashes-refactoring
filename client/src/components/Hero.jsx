...
export default function Hero(props) {
	...
	const handleClick = () => dispatch(setPageMethods.allProducts());

	return (
		<div id="Hero" className="COMPONENT__Hero ">
			{/* Hero Image */}
			<div
				aria-hidden="true"
			...
			<div className="relative max-w-3xl mx-auto xxl:ml-56 py-32 px-6 flex flex-col items-start text-left sm:py-64 lg:px-0">
				...
				<p className="mt-4 text-xl text-white">
					We make lashes your clients love. Stock up on lash
					essentials you can trust.
				</p>
				<a
					href="/#Products"
					onClick={handleClick}

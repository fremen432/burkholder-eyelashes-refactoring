...
function ProductCard(props){
  const { product, page, onAdd, onRemove } = props;
...
//     const { page, onAdd, onRemove, key, setKey } = props;
//     console.log(page)
...
//               product.id = index;
//               return <ProductCard key={index} product={product} page={page} onAdd={onAdd} onRemove={onRemove} />
//           })}
//       </>
//     )
//   }
    ...
    return (
        <div id="Products" className="COMPONENT__AllProducts max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-4 gap-y-10 sm:gap-x-6 sm:grid-cols-2 lg:grid-cols-4  lg:gap-y-0 lg:gap-x-8">
                ...
                {/* <ProductCards key={key} page={page} onAdd={onAdd} onRemove={onRemove} /> */}
